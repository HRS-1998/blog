...
- 子图
  ...
  ![图与子图](http://49.235.131.245/blog/images/graph.png)
...
2. 有向图
   ...
   ![有向图无向图](http://49.235.131.245/blog/images/graph_directed.png)
...
![环图](http://49.235.131.245/blog/images/graph_circle.png)
...
4. 连通图和非连通图
   ...
   ![连通图](http://49.235.131.245/blog/images/graph_connected.png)
   ...
   ![强连通有向图](http://49.235.131.245/blog/images/graph_connected_s.png)
...
- 网络：带权的连通⽆向图称为⽹络。
  ...
  ![带权图](http://49.235.131.245/blog/images/graph_net.png)
...
![边集数组](http://49.235.131.245/blog/images/graph_store1.png) 3. 链式前向星 4. 哈希表实现邻接表
...
![邻接表](http://49.235.131.245/blog/images/graph_store2.png)
...
![生成树](http://49.235.131.245/blog/images/tree_generate.png)

> 最小生成树：最小生成树是指包含图中所有顶点的生成树，其中边的权重之和最小。

![最小生成树](http://49.235.131.245/blog/images/tree_min_generate.png)
